//
//  WutaiOrderDetailViewController.h
//  zhanmao
//
...
@interface WutaiOrderDetailViewController : CustomOrderDetailTableViewController

@property (weak, nonatomic) IBOutlet UILabel *order_num;
@property (weak, nonatomic) IBOutlet UILabel *organizer;
@property (weak, nonatomic) IBOutlet UILabel *name;
@property (weak, nonatomic) IBOutlet UILabel *region;
@property (weak, nonatomic) IBOutlet UILabel *stage_province_city_district;
@property (weak, nonatomic) IBOutlet UILabel *stage_address;
